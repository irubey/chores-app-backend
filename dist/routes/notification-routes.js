...
validate(createNotificationSchema), asyncHandler(NotificationController.createNotification));
/**
 * @route   PATCH /api/notifications/:notificationId/read
 * @desc    Mark a notification as read
 * @access  Protected
 */
router.patch('/:notificationId/read', authMiddleware, validate(markAsReadSchema), asyncHandler(NotificationController.markAsRead));
/**
 * @route   DELETE /api/notifications/:notificationId
 * @desc    Delete a notification
 * @access  Protected
 */
router.delete('/:notificationId', authMiddleware, asyncHandler(NotificationController.deleteNotification));
