...
export class MessageController {
   ...
   * @param next Express NextFunction for error handling
   */
  static async getMessageDetails(req: AuthenticatedRequest, res: Response, next: NextFunction): Promise<void> {
    try {
      if (!req.user) {
        throw new UnauthorizedError('Unauthorized');
      }
   ...
   * @param next Express NextFunction for error handling
   */
  static async updateMessage(req: AuthenticatedRequest, res: Response, next: NextFunction): Promise<void> {
    try {
      if (!req.user) {
        throw new UnauthorizedError('Unauthorized');
      }
   ...
   * @param next Express NextFunction for error handling
   */
  static async addThread(req: AuthenticatedRequest, res: Response, next: NextFunction): Promise<void> {
    try {
      if (!req.user) {
        throw new UnauthorizedError('Unauthorized');
      }
   ...
   * @param next Express NextFunction for error handling
   */
  static async addAttachment(req: AuthenticatedRequest, res: Response, next: NextFunction): Promise<void> {
    try {
      if (!req.user) {
        throw new UnauthorizedError('Unauthorized');
      }
